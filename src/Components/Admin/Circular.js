...
const Circular = () => {
                                ...
                                >
                                    <div className="form-group row ">
                                        <div className="col-sm-12 col-md-12 col-lg-12">
                                            <h3 className="text-center">Add Circular</h3>
                                        ...
                                        <div className="col-sm-4 col-md-4 col-lg-4">
                                            ...
                                            <div className="col-sm-4 col-md-12 col-lg-12">
                                                ...
                                                >
                                                    ...
                                                    <option value={2}>Seminar/Conference/Workshop</option>
                                                    <option value={3}>Trainings</option>
                                                    <option value={4}>Government Resolutions</option>
                                                    <option value={5}>Important Act</option>
    ...
    async function submitCircular(
        ...
        if (values.file) {
            ...
            const params = {
                Bucket: "msbae-assets",
                Key: `circular/${values.file_binary.name}`,
        ...
        if (flag) {
            ...
            if (values.id) {
                ...
                //-----------update-------
                await API.post("/circulars/edit", fd)
                    .then((res) => {
